...
impl Default for Weights {
    fn default() -> Self {
        Self {
            height_weight: Polynomial::new(vec![0.0, -5.0, 0.5]),
            adjacent_height_differences_weight: Polynomial::new(vec![0.0, 5.0, 1.0]),
            total_height_difference_weight: Polynomial::new(vec![0.0, 0.0, 0.5]),
            num_hole_total_weight: Polynomial::new(vec![0.0, 10.0, 4.0]),
            num_hole_weighted_weight: Polynomial::new(vec![0.0, 2.0, 0.0]),
            cell_covered_weight: Polynomial::new(vec![0.0, 0.0, 1.0]),

            t_slot_weight: Polynomial::new(vec![0.0, -100.0, 50.0]),
            b2b_weight: Polynomial::new(vec![0.0, 0.0, 0.0]),
            combo_weight: Polynomial::new(vec![0.0, 0.0, 0.0]),
            damage_weight: Polynomial::new(vec![0.0, 50.0, 0.0, 0.0, -10.0]),
            clear_weight: Polynomial::new(vec![0.0, 100.0, -50.0]),
        }
    }
}
