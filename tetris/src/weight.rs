...
impl Default for Weights {
    fn default() -> Self {
        Self {
            height_weight: Polynomial::new(vec![0.0, 3.0, 0.5]),
            adjacent_height_differences_weight: Polynomial::new(vec![0.0, 0.0, 0.5]),
            ...
            cell_covered_weight: Polynomial::new(vec![0.0, 0.0, 0.0]),
            ...
            damage_weight: Polynomial::new(vec![0.0, 40.0, -20.0]),
            clear_weight: Polynomial::new(vec![0.0, 10.0, -7.0]),
        }
    }
}
