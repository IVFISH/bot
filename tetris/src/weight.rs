...
pub struct Weights {
    ...
    pub t_slot_special_weight: Polynomial<f32>,
...
impl Default for Weights {
    fn default() -> Self {
        Self {
            ...
            t_slot_weight: Polynomial::new(vec![0.0, -400.0, 120.0]),
            t_slot_special_weight: Polynomial::new(vec![0.0, 0.0, 0.0]),
            b2b_weight: Polynomial::new(vec![0.0, -40.0, 2.0]),
