...
impl Default for Weights {
    fn default() -> Self {
        Self {
            ...
            num_hole_total_weight: Polynomial::new(vec![0.0, 4.0, 1.0]),
            num_hole_weighted_weight: Polynomial::new(vec![0.0, 10.0, 2.0]),
            ...
            b2b_weight: Polynomial::new(vec![0.0, -60.0, -2.0]),
            combo_weight: Polynomial::new(vec![0.0, 60.0, -2.0, -1.0]),
            damage_weight: Polynomial::new(vec![0.0, 30.0, -8.0, -1.5]),
            clear_weight: Polynomial::new(vec![0.0, -5.0]),

            waste_t_weight: 600.0,
            tspin_reward: 100.0,
            tspin_reward_expo: 4.0,
