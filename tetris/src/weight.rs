...
impl Default for Weights {
    fn default() -> Self {
        Self {
            ...
            num_hole_total_weight: Polynomial::new(vec![0.0, 20.0, 4.0]),
            num_hole_weighted_weight: Polynomial::new(vec![0.0, 4.0, 1.0]),
            cell_covered_weight: Polynomial::new(vec![0.0, 5.0, 1.0]),

            t_slot_weight: Polynomial::new(vec![0.0, -250.0, 100.0]),
            b2b_weight: Polynomial::new(vec![0.0, 0.0, 0.0]),
            combo_weight: Polynomial::new(vec![0.0, 0.0, 0.0]),
            damage_weight: Polynomial::new(vec![0.0, 10.0, 0.0, 0.0, -1.0]),
            clear_weight: Polynomial::new(vec![0.0, 25.0, -5.0]),
        }
    }
}
