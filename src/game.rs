...
const O_KICKS: [[[[i32; 2]; 5]; 2]; 4] = [[[[0; 2]; 5]; 2]; 4];

// [+X, +Y] = KICKS[piece][rot][ {CW, CCW} ][test#]
pub const KICKS: [[[[[i32; 2]; 5]; 2]; 4]; NUM_PIECES] = [
    // Z
    TLJSZ_KICKS,
    // L
    TLJSZ_KICKS,
...
const TLJSZ_KICKS_180: [[[i32; 2]; 6]; 4] = [
    // N
    [
        // S
        [0, -1],
...
const O_KICKS_180: [[[i32; 2]; 6]; 4] = [[[0; 2]; 6]; 4];

// [+X, +Y] = KICKS[piece][rot][test#]
// see notes about `KICKS`
pub const KICKS_180: [[[[i32; 2]; 6]; 4]; NUM_PIECES] = [
    // Z
    TLJSZ_KICKS_180,
    // L
    TLJSZ_KICKS_180,
